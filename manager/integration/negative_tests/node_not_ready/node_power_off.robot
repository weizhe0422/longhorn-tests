...
1-Power off RWO volume attached node with replica
    ...
    Then Run keyword And Continue On Failure    Node 0 state should be NotReady
    And Run keyword And Continue On Failure    Volume state should be unknown
    And Run keyword And Continue On Failure    Engine state should be unknown
    And Run keyword And Continue On Failure    Replica on the node 0 state should be unknown
...
2-Power off RWO volume not-attached node with replica
    ...
    Then Run keyword And Continue On Failure    Node 1 state should be NotReady
    And Run keyword And Continue On Failure    Volume state should be degraded
    And Run keyword And Continue On Failure    Engine state should be running
    And Run keyword And Continue On Failure    Replica on the node 1 state should be stopped
...
3-Power off RWO volume attached node without replica
    ...
    Then Run keyword And Continue On Failure    Node 2 state should be NotReady
    And Run keyword And Continue On Failure    Volume state should be unknown
    And Run keyword And Continue On Failure    Engine state should be unknown
    And Run keyword And Continue On Failure    Replica on the node 0 state should be running
    And Run keyword And Continue On Failure    Replica on the node 1 state should be stopped
...
4-Power off RWO volume not-attached node without replica
    ...
    When Power off the node 0
    Then Run keyword And Continue On Failure    Node 0 state should be NotReady
    And Run keyword And Continue On Failure    Volume state should be healthy
    And Run keyword And Continue On Failure    Engine state should be running
    And Run keyword And Continue On Failure    Replica on the node 0 state should be stopped
    And Run keyword And Continue On Failure    Check data is intact
    When Power on the node 0
    Then Run keyword And Continue On Failure    Wait Until Keyword Succeeds    ${retry_time_out} seconds    ${retry_interval} seconds    Node 0 state should be Ready
    And Run keyword And Continue On Failure    Wait Until Keyword Succeeds    ${retry_time_out} seconds    ${retry_interval} seconds    Volume state should be unknown
    And Run keyword And Continue On Failure    Wait Until Keyword Succeeds    ${retry_time_out} seconds     ${retry_interval} seconds    Engine state should be unknown
...
13-Power off 2 replica RWO no attach node no replica time out
    ...
    And Sleep ${POD_EVICTION_TIME_OUT} seconds 
    Then Run keyword And Continue On Failure    Node ${node_number_without_replica} state should be NotReady
    And Run keyword And Continue On Failure    Volume state should be healthy
    And Run keyword And Continue On Failure    Engine state should be running
    And Run keyword And Continue On Failure    Replica on the node 0 state should be running
    And Run keyword And Continue On Failure    Replica on the node 1 state should be running
    And Run keyword And Continue On Failure    Check data is intact
