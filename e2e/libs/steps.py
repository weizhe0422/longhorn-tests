...
class steps:
    ...
    def get_non_volume_attached_node(self, attached_node_name):
        print('get_non_volume_attached_node')
        nodes = Nodes.all_nodes
        for node in nodes:
            if node['name'] != attached_node_name:
                print(f'Non volume attached nod:{node}')
                return node['name']
    ...
    def get_no_replica_node(self, volume_name, expected_replica_count):
        ...
        print(f'no_replica_nodes: {no_replica_nodes}')
    ...
    def generate_support_bundle(self, case_name):
        print(f'generate_support_bundle: case_name={case_name}')
